...
@pytest.mark.asyncio
async def test_e2e_delete_task(client: AsyncClient, bearer_token: str, task: Task):
...
@pytest.mark.asyncio
async def test_e2e_delete_task_without_authentication(client: AsyncClient, task: Task):
...
@pytest.mark.asyncio
async def test_e2e_delete_task_with_invalid_id(client: AsyncClient, bearer_token: str, task: Task):
    response = await client.delete(
